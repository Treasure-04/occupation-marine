...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", margin: 0, padding: 0, overflowX: "hidden" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              {[
                ...
                <div key={i} style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <div style={{ color: COLORS.gold, fontSize: "0.72rem", letterSpacing: "2px", textTransform: "uppercase", fontWeight: "60
                    </div>
                </div>
              ))}
            </div>
      ...
      <footer style={{ backgroundColor: "#0a1f3d", color: "rgba(255,255,255,0.5)", textAlign: "center", padding: "30px 6%", fontSize: "0.82rem", lineHeight: 1.8 }}>
        <p>© 2025 Occupation Marine Services & Erudite Agro Tappers Nig Ltd. All rights reserved.</p>
